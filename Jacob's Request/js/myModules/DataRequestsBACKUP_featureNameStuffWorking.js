    ...
    return declare([Evented], {//make a class that 'extends' evented
		...
		*/
        ...
        addLayer: function (layerName) {
            ...
            this.psetNewLayerId(this.primaryLayer,this.myMap.graphicsLayerIds[0]);
...
*/
        ...
        psendQuery: function (queryObject, updateAttachments) {
            ...
            if (!primaryID) {
                this.emit('dataError', { error: 'primary layer not set' }); //this is a page killing error
        ...
        psetLayerNameToID: function () {//TODO: needs refactoring
            ...
            //layerIDs is a pointer, as you remove from myMap you remove from it.
            while (layerIDs[0]) {
                this.myMap.removeLayer(this.myMap.getLayer(layerIDs[0]));
            }
            //set a default primary layer
            this.primaryLayer = this.layerNameAndID[2].name;
            this.addLayer(this.layerNameAndID[2].name);
        },
        /*
